 ...
 */
export const createEmptyBoard = () => Array.from({ length: 9 }, () => Array(9).fill(0));
/**
 ...
 */
export const isBoardComplete = (board) => board.every((row) => row.every((cell) => cell !== 0));
/**
